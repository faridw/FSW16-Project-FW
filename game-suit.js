...
window.onload = function () {
	...
	gunting[0].addEventListener("click", function () {
		...
		userSelect.innerHTML =
			"<p>User</p> <img src='./assets/gunting.png' height='150' width='120'>";
		if (compNumb == 1) {
			versus.innerHTML = "<img src='./assets/versus.png'>";
			computerSelect.innerHTML =
				"<p>Computer</p><img src='./assets/gunting2.png' height='120' width='150'>";
			tampilScoreUser.innerHTML = "User = " + scoreUser;
			tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
		} else if (compNumb == 2) {
			versus.innerHTML = "<img src='./assets/versus.png'>";
			computerSelect.innerHTML =
				"<p>Computer</p><img src='./assets/kertas2.png' height='120' width='150'>";
			scoreUser += 1;
			tampilScoreUser.innerHTML = "User = " + scoreUser;
			tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
		} else if (compNumb == 3) {
			versus.innerHTML = "<img src='./assets/versus.png'>";
			computerSelect.innerHTML =
				"<p>Computer</p><img src='./assets/batu2.png' height='120' width='150'>";
			scoreComputer += 1;
			tampilScoreUser.innerHTML = "User = " + scoreUser;
			tampilScoreComputer.innerHTML = "Computer = " + scoreComputer;
		}
	...
	kertas[0].addEventListener("click", function () {
		compNumb = randomChoose();
		userSelect.innerHTML =
			"<p>User</p> <img src='./assets/kertas.png' height='150' width='120'>";
		if (compNumb == 1) {
			versus.innerHTML = "<img src='./assets/versus.png'>";
			computerSelect.innerHTML =
				"<p>Computer</p><img src='./assets/gunting2.png' height='120' width='150'>";
	...
	batu[0].addEventListener("click", function () {
		compNumb = randomChoose();
		userSelect.innerHTML =
			"<p>User</p> <img src='./assets/batu.png' height='150' width='120'>";
		if (compNumb == 1) {
			versus.innerHTML = "<img src='./assets/versus.png'>";
			computerSelect.innerHTML =
				"<p>Computer</p><img src='./assets/gunting2.png' height='120' width='150'>";
